    ...
    <div class="pt-12 h-screen bg-pink-600 px-12">
        ...
        <div class="w-full rounded-lg bg-pink-800 mt-8 py-5 px-6">
            ...
            <form action="/qwertyuiop" method="POST">
                @csrf 
                <input autocomplete="off" type="text" name="username" id="" class="bg-pink-800 w-full text-slate-100 mt-6 focus:outline-none" placeholder="Username">
                <div class="w-full h-px bg-pink-600 mt-1"></div>
                <input autocomplete="off" type="password" name="password" id="" class="bg-pink-800 w-full text-slate-100 mt-6 focus:outline-none" placeholder="Password">
                <div class="w-full h-px bg-pink-600 mt-1"></div>
